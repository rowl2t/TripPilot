  ...
  return (
    <main>
      <section style={{ ...section, textAlign: 'center' }}>
        ...
        <a href="/pricing">가격 보기</a> · <a href="#waitlist">대기자 등록</a>
      </section>
      ...
      <section id="waitlist" style={section}><h2>앱 다운로드 & 대기자</h2><p>출시 알림을 받고 가장 먼저 사용해보세요.</p><button>Waitlist Join</button></section>
    </main>
  );
}
